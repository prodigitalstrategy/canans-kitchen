      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg mb-4 text-gray-700">
              Our owner, Canan, brings decades of culinary expertise and family recipes passed down through generations. Every dish is crafted with love and attention to detail, ensuring an authentic taste of Turkey in every bite.
            </p>
