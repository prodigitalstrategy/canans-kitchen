...
export const menuItemDetails: Record<string, MenuItemDetailType> = {
  "breakfast-plate": {
    images: ["/images/menu/breakfast-plate.jpeg"],
    funFacts: [
  ...
  "mixed-breakfast-2-person": {
    images: ["/images/menu/mixed-breakfast-3.jpg"],
    funFacts: [
  ...
  "menemen-shakshuka": {
    images: ["/images/menu/menemen-shakshuka.jpg"],
  ...
  "pancakes": {
    images: ["/images/menu/matcha-pancakes.jpg"],
  ...
  "mixed-crepe": {
    images: ["/images/menu/mix-crepe.jpg"],
    funFacts: [
  ...
  "banana-nutella-almond-crepe": {
    images: ["/images/menu/banana_nutella_almond_crepe.jpeg"],
    funFacts: [
  ...
  "nutella-strawberry-banana-crepe": {
    images: ["/images/menu/nutella-crepe.jpg"],
    funFacts: [
  ...
  "meat-eggs-kavurma": {
    images: ["/images/menu/ground-beef-omelette.jpg"],
    funFacts: [
  ...
  "soujuk-omelette": {
    images: ["/images/menu/soucuk_omlette.jpg"],
    funFacts: [
  ...
  "spinach-omelette": {
    images: ["/images/menu/spinach-omlette.jpg"],
